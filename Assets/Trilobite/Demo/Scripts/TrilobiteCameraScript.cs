...
public class TrilobiteCameraScript : MonoBehaviour {
    public GameObject target;
    public float turnSpeed = .2f;
    public GameObject trilobiteCamera;
    ...
    void Update()
    {
        ...
        CameraRotationX();
        CameraRotationY();
        cameraDistance = cameraDistance + Input.GetAxis("Mouse ScrollWheel")*.2f;
        trilobiteCamera.transform.localPosition = new Vector3(0f, cameraDistance, -2f * cameraDistance);
    }
