...
namespace ProceduralPlanets
{
    ...
    {
        const string RING_VERSION = "0.1.1";
        ...
        void Awake()
        {
            if (Manager.Instance.DEBUG_LEVEL > 0) Debug.Log("Ring.cs: Awake()");
            if (Manager.Instance.DEBUG_LEVEL > 0) Debug.Log("- Ring Version: " + RING_VERSION);
            ...
            if (FindObjectOfType<LocalStar>() == null)
                Debug.LogWarning("There is no LocalStar in the scene. Plant will not be lit. Create a game object and add the LocalStar component. The position of the local star game object will be the light source.");
            ...
            if (_planet == null)
            {
                Debug.LogError("Ring parent has no Planet component (or component derived from Planet class).");
                return;
            }
            else
            {
            ...
            AddPropertyMaterial("ringMaterial", "Ring Material*", Manager.Instance.ringMaterials.ToArray(), 10, new string[] { "Ring" });
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 1) Debug.Log("Ring.cs: AddPropertyFloat(" + _key + "," + _label + "," + _minValue + "," + _maxValue + "," + _clamp01 + "," + _displayAsInt + "," + _seedOffset + "," + _variation + "," + _proceduralTextures + "," + _materials + "," + _shaderProperty + "," + _method + "," + _dataType + ")");
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 1) Debug.Log("Ring.cs: AddPropertyExists(" + _key + ")");
        ...
        /// <param name="_seedOffset"></param>
        /// <param name="_proceduralTextures"></param>
        void AddPropertyMaterial(string _key, string _label, ProceduralMaterial[] _materials, int _seedOffset, string[] _proceduralTextures = null)
        {
            if (Manager.Instance.DEBUG_LEVEL > 1) Debug.Log("Ring.cs: AddPropertyMaterial(" + _key + "," + _label + "," + _materials + "," + _seedOffset + "," + _proceduralTextures + "," + _material + ")");
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 1) Debug.Log("Ring.cs: UpdateDictionariesIfNeeded(" + _force + ")");
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 0) Debug.Log("Ring.cs: SetDefaultProperties(" + _leaveOverride + ")");
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 1) Debug.Log("Ring.cs: SetPropertyFloat(" + _key + ")");
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 1) Debug.Log("Ring.cs: OverridePropertyFloat(" + _key + "," + _value + "," + _updateSerializedRingCache + ")");
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 1) Debug.Log("Ring.cs: IsPropertyFloatOverridden(" + _key + ")");
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 1) Debug.Log("Ring.cs: GetPropertyFloat(" + _key + ")");
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 1) Debug.Log("Ring.cs: GetPropertySeededFloat(" + _key + ")");
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 1) Debug.Log("Ring.cs: GetPropertySeededFloat(" + _p + ")");
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 1) Debug.Log("Ring.cs: SetPropertyMaterial(" + _key + ")");
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 1) Debug.Log("Ring.cs: OverridePropertyMaterial(" + _key + "," + _value + "," + _updateSerializedRingCache + ")");
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 1) Debug.Log("Ring.cs: IsPropertyMaterialOverridden(" + _key + ")");
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 1) Debug.Log("Ring.cs: GetPropertyMaterial(" + _key + ")");
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 1) Debug.Log("Ring.cs: GetPropertySeededMaterial(" + _key + ")");
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 1) Debug.Log("Ring.cs: SetBlueprintRing(" + _blueprintRing + ")");
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 1) Debug.Log("Ring.cs: HandleModifiedTextures(" + _proceduralTextures + ")");
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 0) Debug.Log("Ring.cs: RebuildTextures(" + _force + ")");
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 0) Debug.Log("Ring.cs: AssembleFloatArray(" + _map + ")");
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 0) Debug.Log("Ring.cs: UpdateProceduralTexture()");

            UpdateDictionariesIfNeeded();
            // Build an array of PropertyFloat that affect Maps
            proceduralMaterial = _dictionaryMaterials["ringMaterial"].GetPropertyMaterial();
            // Request ProceduralPlanetManager to build the new texture
            Manager.Instance.BuildTexture(proceduralMaterial, "Ring", true, true, AssembleFloatArray("Ring"), this);                       
        }
        ...
        /// by BuildTextureRoutine() it will be copied to a Texture2D which is then assigned to the planetary ring using this method.
        /// </summary>
        /// <param name="_textureName"></param>
        /// <param name="_textureDiffuse"></param>
        public void SetTexture(string _textureName, Texture2D _textureDiffuse)
        {
            if (Manager.Instance.DEBUG_LEVEL > 0) Debug.Log("Ring.cs: UpdateProceduralTexture(" + _textureName + "," + _textureDiffuse + ")");

            switch (_textureName)
            {
                case "Ring":
                    _textureRing = _textureDiffuse;
                    for (int _i = 0; _i < 2; _i++)
                        _material[_i].SetTexture("_MainTex", _textureRing);
                    break;
            }
        }
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 0) Debug.Log("Ring.cs: UpdateProperties()");
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 0) Debug.Log("Ring.cs: CreateMeshes()");
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 0) Debug.Log("Ring.cs: CreateMaterials()");
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 0) Debug.Log("Ring.cs: ExportToJSON(" + _format + ")");
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 0) Debug.Log("Ring.cs: ImportFromJSON(" + _jsonString+ ")");
            ...
            BlueprintRing _bpr  = Manager.Instance.GetRingBlueprintByPlanetBlueprintName(_planet.blueprint.name);
