/*  
    Class: ProceduralPlanets.Properties
...
namespace ProceduralPlanets
{
    ...
    public class PropertyMaterial
    {
        ...
        /// </summary>
        /// <returns></returns>
        public ProceduralMaterial GetPropertyMaterial()
        {
        ...
        /// <param name="_shaderProperty"></param>
        public PropertyMaterial(string _key, string _label, ProceduralMaterial[] _materials, int _seedOffset, string[] _proceduralTextures = null, Material _material = null, string _shaderProperty = null)
        {
            key = _key;
            label = _label;
            materials = _materials;
