/*  
    Class: ProceduralPlanets.BlueprintRing
...
namespace ProceduralPlanets
{
    ...
    {
        const string BLUEPRINT_RING_VERSION = "0.1.1";
        ...
        void Reset()
        {
            ...
            Manager _manager = transform.parent.parent.GetComponent<Manager>();
            ...
            AddBlueprintPropertyMaterial("ringMaterial", "Ring Material", Manager.Instance.ringMaterials.ToArray());
