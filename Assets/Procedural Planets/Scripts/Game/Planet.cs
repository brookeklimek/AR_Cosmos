/*  
    Class: ProceduralPlanets.Planet
...
namespace ProceduralPlanets
{
    ...
    {
        protected const string PLANET_VERSION = "0.1.1";
        ...
        protected bool _isRebuildingTextures = false;
        protected float _timerStartBuildingTextures = 0f;
        ...
        // String format alternatives for planet export
        ...
        // EVENTS
        protected List<GameObject> _objectsToNotify = new List<GameObject>(0);
        ...
        // Require all derived classes to have an IsRegeneratingTextures Method
        public abstract bool IsRegeneratingTextures();
        ...
        public abstract void SetTexture(string _textureName, Texture2D _textureDiffuse, Texture2D _textureNormal, Texture2D _textureFlow);
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 0) Debug.Log("Planet.cs: AssembleFloatArray(" + _map + ")");
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 0) Debug.Log("Planet.cs: SetDefaultProperties(" + _leaveOverride +")");
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 1) Debug.Log("Planet.cs: SetPropertyFloat(" + _key + ")");
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 1) Debug.Log("Planet.cs: UpdatePropertyFloatShader(" + _propertyFloat + ")");
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 1) Debug.Log("Planet.cs: SetPropertyColor" + _key + ")");
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 1) Debug.Log("Planet.cs: UpdatePropertyColorShader(" + _propertyColor + ")");
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 1) Debug.Log("Planet.cs: SetPropertyMaterial(" + _key + ")");
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 1) Debug.Log("Planet.cs: UpdateDictionariesIfNeeded(" + _force + ")");
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 0) Debug.Log("Planet.cs: GenerateLookupTexture(" + _level + "," + _detail + ")");

            Texture2D _texture = new Texture2D(_detail, 1);
            Color32[] _col32 = new Color32[_detail];
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 0) Debug.Log("Planet.cs: GenerateSmoothLookupTexture(" + _level + "," + _lowLimit + "," + _upLimit + ")");

            Texture2D _texture = new Texture2D(256, 1);
            Color32[] _col32 = new Color32[256];
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 1) Debug.Log("Planet.cs: AddPropertyFloat(" + _key + "," + _label + "," + _minValue + "," + _maxValue + "," + _clamp01 + "," + _displayAsInt + "," + _seedOffset + "," + _variation + "," + _proceduralTextures + "," + _materials + "," + _shaderProperty + "," + _method + "," + _dataType + ")");
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 1) Debug.Log("Planet.cs: AddPropertyColor(" + _key + "," + _label + "," + _baseColor + "," + _hueRange + "," + _saturationRange + "," + _brightnessRange + "," + _seedOffset + "," + _variation + "," + _material + "," + _shaderProperty + ")");
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 1) Debug.Log("Planet.cs: AddPropertyColor(" + _key + "," + _label + "," + _baseColor + "," + _hueRange + "," + _saturationRange + "," + _brightnessRange + "," + _seedOffset + "," + _variation + "," + _materials + "," + _shaderProperty + ")");
        ...
        /// <param name="_material"></param>
        /// <param name="_shaderProperty"></param>
        protected virtual void AddPropertyMaterial(string _key, string _label, ProceduralMaterial[] _materials, int _seedOffset, string[] _proceduralTextures = null, Material _material = null, string _shaderProperty = null)
        {
            if (Manager.Instance.DEBUG_LEVEL > 1) Debug.Log("Planet.cs: AddPropertyMaterial(" + _key + "," + _label + "," + _materials + "," + _seedOffset + "," + _proceduralTextures + "," + _material + "," + _shaderProperty + ")");
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 1) Debug.Log("Planet.cs: GetPropertySeededFloat(" + _key + ")");
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 1) Debug.Log("Planet.cs: GetPropertySeededFloat(" + _propertyFloat + ")");
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 1) Debug.Log("Planet.cs: OverridePropertyFloat(" + _key + "," + _value + "," + _updateSerializedPlanetCache + ")");
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 1) Debug.Log("Planet.cs: IsPropertyFloatOverridden(" + _key + ")");
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 1) Debug.Log("Planet.cs: GetPropertyFloat(" + _key + ")");
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 1) Debug.Log("Planet.cs: GetPropertySeededColor(" + _key + ")");
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 1) Debug.Log("Planet.cs: OverridePropertyColor(" + _key + "," + _color + "," + _updateSerializedPlanetCache + ")");
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 1) Debug.Log("Planet.cs: IsPropertyColorOverridden(" + _key + ")");
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 1) Debug.Log("Planet.cs: GetPropertyColor(" + _key + ")");
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 1) Debug.Log("Planet.cs: GetPropertySeededMaterial(" + _key + ")");
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 1) Debug.Log("Planet.cs: OverridePropertyMaterial(" + _key + "," + _value + "," + _updateSerializedPlanetCache + ")");
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 1) Debug.Log("Planet.cs: IsPropertyMaterialOverridden(" + _key + ")");
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 1) Debug.Log("Planet.cs: GetPropertyMaterial(" + _key + ")");
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 0) Debug.Log("Planet.cs: CreateRing(" + _jsonString + ")");
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 0) Debug.Log("Planet.cs: HasRing()");
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 0) Debug.Log("Planet.cs: GetRing()");
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 0) Debug.Log("Planet.cs: ExportToJSON(" + _format + ")");
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 0) Debug.Log("Planet.cs: ImportFromJSON(" + _jsonString + "," + _createRing + ")");
            ...
            int _newIndex = Manager.Instance.GetPlanetBlueprintIndexByName(N["planet"]["blueprintName"]);
            ...
            if (Manager.Instance.GetPlanetBlueprintNameByIndex(N["planet"]["blueprintIndex"], blueprint) == Manager.Instance.GetPlanetBlueprintNameByIndex(GetPlanetBlueprintSeededIndex(), blueprint))
            {
        ...
        {
            if (Manager.Instance.DEBUG_LEVEL > 0) Debug.Log("Planet.cs: GetRingBlueprint()");
        ...
        public void SubscribeMessageOnTextureBuildComplete(GameObject _gameObject)
        {
            if (Manager.Instance.DEBUG_LEVEL > 0) Debug.Log("Planet.cs: SubscribeMessageOnTextureBuildComplete(" + _gameObject + ")");

            _objectsToNotify.Add(_gameObject);
        }

        protected void SendMessageOnTextureBuildComplete()
        {
            if (Manager.Instance.DEBUG_LEVEL > 0) Debug.Log("Planet.cs: SendMessageOnTextureBuildComplete()");

            for (int _i = _objectsToNotify.Count - 1; _i >= 0; _i--)
            {
                if (_objectsToNotify[_i] == null)
                    _objectsToNotify.RemoveAt(_i);
                else
                {
                    _objectsToNotify[_i].SendMessage("OnTextureBuildComplete", Time.time - _timerStartBuildingTextures, SendMessageOptions.DontRequireReceiver);
                }
            }
        }
    }
