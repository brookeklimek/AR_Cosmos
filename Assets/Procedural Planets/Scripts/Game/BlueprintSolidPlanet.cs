/*  
    Class: ProceduralPlanets.BlueprintSolidPlanet
...
namespace ProceduralPlanets
{
    public class BlueprintSolidPlanet : BlueprintPlanet
    {
        ...
        void Reset()
        {
            ...
            Manager _manager = transform.parent.GetComponent<Manager>();
            ...
            AddBlueprintPropertyMaterial("composition", "Composition", Manager.Instance.solidCompositionMaterials.ToArray());
            ...
            AddBlueprintPropertyMaterial("polarIce", "Polar Ice", Manager.Instance.solidPolarIceMaterials.ToArray());
            ...
            AddBlueprintPropertyMaterial("clouds", "Clouds", Manager.Instance.solidCloudsMaterials.ToArray());
            ...
            AddBlueprintPropertyMaterial("lava", "Lava", Manager.Instance.solidLavaMaterials.ToArray());
            ...
            AddBlueprintPropertyMaterial("biome1Type", "Biome 1 Type", Manager.Instance.solidBiome1Materials.ToArray());
            ...
            AddBlueprintPropertyMaterial("biome2Type", "Biome 2 Type", Manager.Instance.solidBiome2Materials.ToArray());
            ...
            AddBlueprintPropertyMaterial("cities", "Cities", Manager.Instance.solidCitiesMaterials.ToArray());
